...
import { aiAssistance_usecase_http } from '../aiAssistance.module.js';
...
export function AiAssistanceRoutes(): Router {
        ...
        aiRoutes.post(
                ...
                protectHandler(async (req: Request, res: Response) => {
                        ...
                        const result = await aiAssistance_usecase_http.improveSection.execute({
                                userId,
                                resumeId,
                                sectionType,
                                content
        ...
        aiRoutes.post(
                ...
                protectHandler(async (req: Request, res: Response) => {
                        ...
                        const result = await aiAssistance_usecase_http.tailorResume.execute({
                                userId,
                                resumeId,
                                jobId,
                                resumeSnapshot,
        ...
        aiRoutes.post(
                ...
                protectHandler(async (req: Request, res: Response) => {
                        ...
                        const result = await aiAssistance_usecase_http.extractJobRequirements.execute({
                                jobId,
                                jobDescription
                        });
        ...
        aiRoutes.get(
                ...
                protectHandler(async (req: Request, res: Response) => {
                        ...
                        const history = await aiAssistance_usecase_http.getLatestAiSuggestions.execute(
                                userId,
                                limit
                        );
        ...
        aiRoutes.post(
                ...
                protectHandler(async (req: Request, res: Response) => {
                        ...
                        const preview = await aiAssistance_usecase_http.previewTailoredResume.execute({
                                resumeSnapshot,
                                jobDescription
                        });
